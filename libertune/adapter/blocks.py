# coding=utf-8
# Copyright 2023 Adapter AI and the HuggingFace Inc. team. All rights reserved.
#
...
# Copied from transformers.models.llama.modeling_llama.LlamaRMSNorm with Llama->Adapter
...
# Copied from transformers.models.llama.modeling_llama.LlamaRotaryEmbedding with Llama->Adapter
...
class AdapterAttention(nn.Module):
    ...
    def __init__(self, config: Dict, layer_idx: Optional[int] = None):
        ...
        self.rotary_emb = AdapterRotaryEmbedding(
            self.head_dim,
...
class AdapterDecoderLayer(nn.Module):
    def __init__(self, config: Dict, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.self_attn = AdapterAttention(config, layer_idx)
